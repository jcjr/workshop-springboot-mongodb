...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("10/08/2024"), "Partiu Viagem", "Vou Viajar para São Paulo. Abraços", maria);
		Post post2 = new Post(null, sdf.parse("11/08/2024"), "Bom dia", "Acordei feliz hoje", maria);
